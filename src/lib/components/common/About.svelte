	...
	<div class="hero-content text-center">
		<div class="max-w-4/6">
			...
			<p class="m-3 text-justify text-lg">
				...
				et je veille à livrer des produits utiles, performants et bien pensés. J'accorde aussi une grande
				importance à la collaboration, au partage de connaissances et à la qualité du code dans un environnement
				d'équipe.
			</p>
		</div>
	</div>

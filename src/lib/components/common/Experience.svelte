			...
			<ul class="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical m-3">
				<li>
					...
					<div class="timeline-start mb-10 md:text-end">
						...
						<p>
							<strong>Amélioration des performances : </strong> Réduction du temps de chargement des
							pages de sites utilisant le CMS WordPress.
						</p>
						<p>
							<strong>Modification de site web : </strong> Adaptation de scripts PHP et CSS sur des sites
							web existants afin d'améliorer le design ou d'ajouter de nouvelles fonctionnalités.
						</p>
					</div>
					<hr />
				</li>
				<li>
					...
					<div class="timeline-end md:mb-10">
						...
						<p>
							<strong>Résolution de ticket : </strong> Création de pull request permettant de résoudre
							les tickets.
						</p>
						<p>
							<strong>CI (Continuous Integration) : </strong> Ajout d'un CI pour veiller à la non régression
							et taux de couverture de test
						</p>
					</div>
					<hr />
				</li>
				<li>
					...
					<div class="timeline-start mb-10 md:text-end">
						...
						<p>
							<strong>Maintenance et optimisation des sites web : </strong> Assurer la performance, la
							sécurité et l'évolution des sites en fonction des besoins utilisateurs et des tendances
							techniques.
						</p>
						<p>
							<strong>Création d'un serveur : </strong> Pour permettre à un client de stocker et partager
							diverses données avec ses collaborateurs.
						</p>
					</div>
					<hr />
				</li>
				<li>
					...
					<div class="timeline-end md:mb-10">
						...
						<p>
							<strong>Macro excel : </strong> Création d'une macro excel pour répondre à un besoin spontané
							et urgent du corps professoral.
						</p>
					</div>
					<hr />
				</li>
				...
				<li>
					...
					<div class="timeline-end md:mb-10">
						...
						<p>
							<strong>Système d'exploitation : </strong> Installation et mise à jour des différents ordinateurs
